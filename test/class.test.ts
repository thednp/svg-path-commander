...
a1.63 1.63 0 0 0 -0.906 0.274a1.63 1.63 0 0 0 -0.601 0.73a1.63 1.63 0 0 0 -0.094 0.942a1.63 1.63 0 0 0 3.229 -0.314a1.6 1.6 0 0 0 -0.12 -0.627a1.6 1.6 0 0 0 -0.353 -0.533a1.6 1.6 0 0 0 -0.53 -0.356a1.6 1.6 0 0 0 -0.625 -0.125za1.63 1.63 0 0 0 -0.906 0.274a1.63 1.63 0 0 0 -0.601 0.73a1.63 1.63 0 0 0 -0.094 0.942a1.63 1.63 0 0 0 3.229 -0.314a1.6 1.6 0 0 0 -0.12 -0.627a1.6 1.6 0 0 0 -0.353 -0.533a1.6 1.6 0 0 0 -0.53 -0.356a1.6 1.6 0 0 0 -0.625 -0.125z`);
  ...
  test('Test class getters', async () => {
    // const instance = new SVGPathCommander('M2 0L2 2');
    expect(SVGPathCommander.absolutizeSegment).toBeDefined();
    expect(SVGPathCommander.arcToCubic).toBeDefined();
    expect(SVGPathCommander.getSVGMatrix).toBeDefined();
    expect(SVGPathCommander.iterate).toBeDefined();
    expect(SVGPathCommander.options).toBeDefined();
    expect(SVGPathCommander.CSSMatrix).toBeDefined();
    expect(SVGPathCommander.arcTools).toBeDefined();
    expect(SVGPathCommander.bezierTools).toBeDefined();
    expect(SVGPathCommander.cubicTools).toBeDefined();
    expect(SVGPathCommander.lineTools).toBeDefined();
    expect(SVGPathCommander.polygonTools).toBeDefined();
    expect(SVGPathCommander.quadTools).toBeDefined();
    expect(SVGPathCommander.pathToAbsolute).toBeDefined();
    expect(SVGPathCommander.pathToRelative).toBeDefined();
    expect(SVGPathCommander.pathToCurve).toBeDefined();
    expect(SVGPathCommander.pathToString).toBeDefined();
    expect(SVGPathCommander.distanceSquareRoot).toBeDefined();
    expect(SVGPathCommander.distanceEpsilon).toBeDefined();
    expect(SVGPathCommander.midPoint).toBeDefined();
    expect(SVGPathCommander.rotateVector).toBeDefined();
    expect(SVGPathCommander.roundTo).toBeDefined();
    expect(SVGPathCommander.parsePathString).toBeDefined();
    expect(SVGPathCommander.finalizeSegment).toBeDefined();
    expect(SVGPathCommander.invalidPathValue).toBeDefined();
    expect(SVGPathCommander.isArcCommand).toBeDefined();
    expect(SVGPathCommander.isDigit).toBeDefined();
    expect(SVGPathCommander.isDigitStart).toBeDefined();
    expect(SVGPathCommander.isMoveCommand).toBeDefined();
    expect(SVGPathCommander.isPathCommand).toBeDefined();
    expect(SVGPathCommander.isCurveArray).toBeDefined();
    expect(SVGPathCommander.isNormalizedArray).toBeDefined();
    expect(SVGPathCommander.isPathArray).toBeDefined();
    expect(SVGPathCommander.isPointInStroke).toBeDefined();
    expect(SVGPathCommander.isRelativeArray).toBeDefined();
    expect(SVGPathCommander.isValidPath).toBeDefined();
    expect(SVGPathCommander.isSpace).toBeDefined();
    expect(SVGPathCommander.scanParam).toBeDefined();
    ...
    expect(SVGPathCommander.scanSegment).toBeDefined();
    expect(SVGPathCommander.skipSpaces).toBeDefined();
    expect(SVGPathCommander.distanceEpsilon).toBeDefined();
    expect(SVGPathCommander.getClosestPoint).toBeDefined();
    expect(SVGPathCommander.getDrawDirection).toBeDefined();
    expect(SVGPathCommander.getPathArea).toBeDefined();
    expect(SVGPathCommander.getPointAtLength).toBeDefined();
    expect(SVGPathCommander.getPropertiesAtLength).toBeDefined();
    expect(SVGPathCommander.getPropertiesAtPoint).toBeDefined();
    expect(SVGPathCommander.getSegmentAtLength).toBeDefined();
    expect(SVGPathCommander.getSegmentOfPoint).toBeDefined();
    expect(SVGPathCommander.getTotalLength).toBeDefined();
    expect(SVGPathCommander.isAbsoluteArray).toBeDefined();
    expect(SVGPathCommander.lineToCubic).toBeDefined();
    expect(SVGPathCommander.normalizePath).toBeDefined();
    expect(SVGPathCommander.normalizeSegment).toBeDefined();
    expect(SVGPathCommander.optimizePath).toBeDefined();
    expect(SVGPathCommander.projection2d).toBeDefined();
    expect(SVGPathCommander.quadToCubic).toBeDefined();
    expect(SVGPathCommander.relativizeSegment).toBeDefined();
    expect(SVGPathCommander.reversePath).toBeDefined();
    expect(SVGPathCommander.roundPath).toBeDefined();
