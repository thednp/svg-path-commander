...
describe('SVGPathCommander Class Test', () => {
  ...
  it('Test toCurve', () => {
    ...
    cy.get('@svgpath').then((svg) => {
        ...
        expect(svg[0].getAttribute('d')).to.equal('M2 0C0.8954304997175604 -8.780183295920349e-10 -1.3527075029566811e-16 0.8954304997175604 0 2C0 2 0 9.875 0 14C1.3527075029566811e-16 15.10456950028244 0.8954304997175604 16.000000000878018 2 16C8 16 10.25 16 14 16C15.104569499040734 15.999999999121982 16 15.104569499040734 16 14C16 8 16 5.75 16 2C16 0.8954305009592662 15.104569499040734 8.780185991465076e-10 14 0C8 0 5.75 0 2 0C2 0 2 0 2 0')
      })
  });
